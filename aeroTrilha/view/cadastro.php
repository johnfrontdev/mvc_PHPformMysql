...
<?php
include 'view/navbarDinamico.php';
?>
...
<div class="container">
    <div class="card-header text-white" style="background-color: #21276a; text-align: center; border-bottom-right-radius: 20px; border-radius: 20px;">Criar conta</div>
    <br>
    <div class="card-header text-white" style="background-color: #21276a; border-top-right-radius: 20px; border-top-left-radius: 20px; ">Dados pessoais</div>
    ...
    <div class="card-header text-white" style="background-color: #21276a;">Dados de login para sua conta</div>
    <div class="card-header">
    ...
    <div class="card-footer" style="border-bottom-right-radius: 20px; border-bottom-left-radius: 20px;">
      <div class="text-center">
        Já possui uma conta? <a href="LOGIN" style="color: #21276a;">Faça login</a>
      </div>
    </div>
    </form>
